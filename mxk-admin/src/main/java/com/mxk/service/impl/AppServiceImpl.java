...
import com.mxk.bean.Plugin;
import com.mxk.constants.EnabledEnum;
import com.mxk.exception.MxkException;
import com.mxk.mapper.AppPluginMapper;
import com.mxk.mapper.PluginMapper;
...
import com.mxk.transfer.AppInstanceTransfer;
import com.mxk.transfer.AppVOTransfer;
...
public class AppServiceImpl implements AppService {
    ...
    private void bindPlugins(App app) {
        ...
        if (CollectionUtils.isEmpty(plugins)) {
            throw new MxkException("must init plugins first!");
        }
        plugins.forEach(p -> {
    ...
    public void delete(Integer id) {
        ...
        if (!CollectionUtils.isEmpty(instances)){
            throw new MxkException("该服务存在实例不可删除！");
        }
