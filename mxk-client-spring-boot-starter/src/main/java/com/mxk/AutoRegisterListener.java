...
/**
 *  1、mxk-high-gate 启动的时候，先调用 AutoRegisterListener 的构造方法
...
public class AutoRegisterListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public AutoRegisterListener(ClientConfigProperties properties) {
        if (!check(properties)) {
            ...
            throw new MxkException("client config port,contextPath,appName adminUrl and version can't be empty!");
        }
    ...
    /**
     * 验证 ClientConfigProperties 属性是否为空
     */
    ...
    */
    ...
    private void registerShutDownHook() {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            ...
            LOGGER.info("[{}:{}] unregister from mxk-admin success!", unregisterAppDTO.getAppName(), unregisterAppDTO.getVersion());
        }));
    }
    ...
    private void doRegister() {
        ...
        try {
            ...
            throw new MxkException(e.getErrCode(), e.getErrMsg());
        }
        LOGGER.info("register interface info to nacos success!");
        // send register request to mxk-admin
        ...
        LOGGER.info("register to mxk-admin success!");
    }
